...
app.get("/scrape", function(req, res) {
    request("https://www.nytimes.com/section/arts?WT.nav=page&action=click&contentCollection=Arts&module=HPMiniNav&pgtype=Homepage&region=TopBar", function(error, response, html) {
